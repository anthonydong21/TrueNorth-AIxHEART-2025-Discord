...
vectorstore_content_summary = "LangChain test document, communcation strategies rooted in conflict resolution and diplomacy, positive psychology, dialectical behavioral therapy, leadership skills, coping mechanisms"

system_relevant_scope = "specific insights on user's current lived environment, and information about maintaining positive trajectory towards maximizing STEM career"
